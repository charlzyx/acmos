class Acmos < Formula
  ...
  url "https://github.com/charlzyx/acmos/releases/download/v0.1.5/acmos"
  sha256 "8fe41c8bb0a9bd7109c87979a050d804e8199c95a3c4e863e3505e25851bb740"
  license "MIT"
  ...
  test do
    assert_match "0.1.5", shell_output("#{bin}/acmos --version")
  end
end
