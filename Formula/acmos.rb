class Acmos < Formula
  ...
  url "https://github.com/charlzyx/acmos/releases/download/v0.1.6/acmos"
  sha256 "e3360748b44fa5e71eeb4679219c458c64b022d70921a34928f48bfe6eaca013"
  license "MIT"
  ...
  test do
    assert_match "0.1.6", shell_output("#{bin}/acmos --version")
  end
end
