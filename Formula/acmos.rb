class Acmos < Formula
  ...
  url "https://github.com/charlzyx/acmos/releases/download/v0.1.7/acmos"
  sha256 "cfb40edd2247a8f34e91a13848a3cecc21c718ed48718be9c9a1e3861329a4dc"
  license "MIT"
  ...
  test do
    assert_match "0.1.7", shell_output("#{bin}/acmos --version")
  end
end
